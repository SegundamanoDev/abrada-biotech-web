...
import { FaQuoteLeft, FaBiohazard } from "react-icons/fa";
...
const Home = () => {
  return (
    <div className="bg-white overflow-hidden">
      ...
      {/* 2. THE TRUST STRIP (Essential for high-end conversion) */}
      ...
      {/* 3. CORE TECHNOLOGY (Updated Design) */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight">
              Biotech Engineering <br /> Meet Modern Household Needs
            </h3>
          </div>
      ...
      {/* NEW SECTION: THE RESEARCH NARRATIVE */}
      <section className="py-24 bg-[#1B4332] relative overflow-hidden">
        {/* Decorative Biology Pattern */}
